...
- **Method**: `deleteFeedPost(Integer postId, UUID userId)`
...
```json
{
  "basePost": {
    ...
    "authorId": "b5d58017-68dc-416e-be64-4304f2219119"
  },
  "postType": "share"
}
```
...
```json
{
  ...
  "title": "Post title",
  "content": "Post content",
  "author": "b5d58017-68dc-416e-be64-4304f2219119",
...
- `userId` (UUID) - ID of the user requesting deletion
...
- **Method**: `getClassifiedById(UUID postId)`
...
- **Method**: `updateClassifiedPostStatus(Integer postId, UUID userId, String newStatus)`
...
- **Method**: `applyToClassifiedPost(Integer postId, UUID userId)`
...
- **Method**: `getApplicationsForClassifiedPost(Integer postId, UUID userId)`
...
- **Method**: `getAppliedClassifiedPostsByUser(UUID userId)`
...
```json
{
  ...
  "content": "Looking for an experienced Java developer for our project",
  "author": "b5d58017-68dc-416e-be64-4304f2219119",
  "projectId": "a3d43117-28bf-41le-be64-4304f2219119",
  "status": "open",
  "createdAt": "2026-03-08T10:30:00",
...
- `userId` (UUID) - ID of the user requesting the update
...
```json
{
  ...
  "title": "Seeking Java Developer",
  "content": "Looking for an experienced Java developer for our project",
  "author": "a3d43117-28bf-41le-be64-4304f2219119",
  "projectId": "b5d58017-68dc-416e-be64-4304f2219119",
  "status": "filled",
  "createdAt": "2026-03-22T11:30:00",
  "updatedAt": "2026-03-22T11:30:00"
}
...
```json
{
  "userId": "b5d58017-68dc-416e-be64-4304f2219119"
}
```
...
- `userId` (UUID) - ID of the user requesting the applications
...
[
  {
    ...
    "content": "Looking for an experienced Java developer for our project",
    "author": "b5d58017-68dc-416e-be64-4304f2219119",
    "projectId": "a4f58017-84kd-416e-be64-4304f2213957",
    "status": "open",
    "createdAt": "2026-03-22T11:30:00",
    "updatedAt": "2026-03-22T11:30:00"
  }
...
- **Method**: `unlikePost(Integer postId, UUID userId)`
...
- **Method**: `deleteComment(Integer commentId, UUID userId)`
...
- **Method**: `likeComment(Integer commentId, UUID userId)`
...
- **Method**: `unlikeComment(Integer commentId, UUID userId)`
...
- **Method**: `getPostActions(Integer postId, UUID currentUserId)`
...
- `userId` (UUID, optional) - ID of the current user (to check if they liked the post)
...
- **Method**: `sendMessage(UUID conversationId, UUID recipientId, String content)`
...
- **Method**: `getOrCreateConversation(UUID senderId, UUID recipientId)`
...
```json
{
  "conversationId": "b5d58017-68dc-416e-be64-43043495854",
  "senderId": "b5d58017-68dc-416e-be64-4304f2219119",
  "content": "Hi there"
}
```
...
```json
{
  "conversationId": "b5d58017-10sd-394d-be64-4304f2219119",
  "messageId": 10,
  "senderId": "b5d58017-68dc-416e-be64-4304f2219119",
  "recipientId": "b5d58017-95dc-284e-be64-4304f2219119",
  "content": "Hi there",
  "createdAt": "2026-03-22T11:30:00"
}
```
...
- `userId` (UUID) - ID of the user requesting the messages
...
[
  {
    "id": 10,
    "conversationId": "b5d58017-68dc-416e-be64-4304f2219119",
    "senderId": "b5d58017-29as-492f-be64-4304f2219119",
    "content": "Hi there",
    "createdAt": "2026-03-22T11:30:00"
  }
]
...
- **Method**: `getClassifiedNotifications(UUID userId, boolean unread)`
...
- **Method**: `getMessageNotifications(UUID userId, boolean unread)`
- **Description**: Retrieves message notifications for a user, with an option to filter by unread
- **Returns**: `List<NotificationResponse>`

#### 4. Mark Notification as Read

- **Method**: `markAsRead(Integer notificationId, UUID userId)`
...
[
  {
    "id": 5,
    "recipientId": "b5d58017-68dc-416e-be64-4304f2219119",
    "senderUserId": "b5d58017-39fc-102a-be64-4304f2219119",
...
[
  {
    "id": 6,
    "recipientId": "b5d58017-68dc-416e-be64-4304f2219119",
    "senderUserId": "b5d58017-10fc-984d-be64-4304f2219119",
    "type": "MESSAGE",
    "message": "Hey there",
    "classifiedPostId": null,
    "conversationId": "b5d58017-15fc-029g-be64-4304f2219119",
    "isRead": false,
    "createdAt": "2026-03-22T11:30:00",
    "readAt": null
  }
